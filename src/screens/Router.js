...
import {useMyContextController, deleteService} from '../context';
...
import DetailService from './DeleteService';
...
const AdminScreens = () => {
  const handleDelete = (id, navigation) => {
    Alert.alert(
      'Cảnh báo',
      'Bạn có chắc chắn muốn xóa dịch vụ này không? Thao tác này không thể được trả lại',
      [
        {
          text: 'Delete',
          onPress: async () => {
